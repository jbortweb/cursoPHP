...
<!--Con el metodo get el usuario puede cambiar los datos y el codigo a traves del navegador.-->

<form action="03_1recibe.php" method="get" name="" id="" class=""> <!-- La identidad en php la das a traves del atributi name --> 
